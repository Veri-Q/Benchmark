...
h q[40];
h q[41];
cu1(pi/512) q[41],q[42];
cu1(pi/256) q[40],q[42];
cu1(pi/128) q[39],q[42];
cu1(pi/64) q[38],q[42];
cu1(pi/32) q[37],q[42];
cu1(pi/16) q[36],q[42];
cu1(pi/8) q[35],q[42];
...
cu1(32*pi) q[27],q[42];
cu1(64*pi) q[26],q[42];
cu1(128*pi) q[25],q[42];
cu1(256*pi) q[24],q[42];
cu1(512*pi) q[23],q[42];
cu1(1024*pi) q[22],q[42];
cu1(2048*pi) q[21],q[42];
cu1(4096*pi) q[20],q[42];
cu1(8192*pi) q[19],q[42];
cu1(16384*pi) q[18],q[42];
cu1(32768*pi) q[17],q[42];
cu1(65536*pi) q[16],q[42];
cu1(131072*pi) q[15],q[42];
cu1(262144*pi) q[14],q[42];
cu1(524288*pi) q[13],q[42];
cu1(1048576*pi) q[12],q[42];
cu1(2097152*pi) q[11],q[42];
cu1(4194304*pi) q[10],q[42];
cu1(8388608*pi) q[9],q[42];
cu1(16777216*pi) q[8],q[42];
cu1(33554432*pi) q[7],q[42];
cu1(67108864*pi) q[6],q[42];
cu1(134217728*pi) q[5],q[42];
cu1(268435456*pi) q[4],q[42];
cu1(536870912*pi) q[3],q[42];
cu1(1073741824*pi) q[2],q[42];
cu1(2147483648*pi) q[1],q[42];
cu1(4294967296*pi) q[0],q[42];
h q[0];
measure q[0] -> c0[0];
if(c0==1) u1(-pi/2) q[1];
if(c0==1) u1(-pi/4) q[2];
