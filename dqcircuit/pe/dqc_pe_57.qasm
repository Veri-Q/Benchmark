...
h q[55];
h q[56];
cu1(pi/512) q[56],q[57];
cu1(pi/256) q[55],q[57];
cu1(pi/128) q[54],q[57];
cu1(pi/64) q[53],q[57];
cu1(pi/32) q[52],q[57];
cu1(pi/16) q[51],q[57];
cu1(pi/8) q[50],q[57];
...
cu1(32*pi) q[42],q[57];
cu1(64*pi) q[41],q[57];
cu1(128*pi) q[40],q[57];
cu1(256*pi) q[39],q[57];
cu1(512*pi) q[38],q[57];
cu1(1024*pi) q[37],q[57];
cu1(2048*pi) q[36],q[57];
cu1(4096*pi) q[35],q[57];
cu1(8192*pi) q[34],q[57];
cu1(16384*pi) q[33],q[57];
cu1(32768*pi) q[32],q[57];
cu1(65536*pi) q[31],q[57];
cu1(131072*pi) q[30],q[57];
cu1(262144*pi) q[29],q[57];
cu1(524288*pi) q[28],q[57];
cu1(1048576*pi) q[27],q[57];
cu1(2097152*pi) q[26],q[57];
cu1(4194304*pi) q[25],q[57];
cu1(8388608*pi) q[24],q[57];
cu1(16777216*pi) q[23],q[57];
cu1(33554432*pi) q[22],q[57];
cu1(67108864*pi) q[21],q[57];
cu1(134217728*pi) q[20],q[57];
cu1(268435456*pi) q[19],q[57];
cu1(536870912*pi) q[18],q[57];
cu1(1073741824*pi) q[17],q[57];
cu1(2147483648*pi) q[16],q[57];
cu1(4294967296*pi) q[15],q[57];
cu1(8589934592*pi) q[14],q[57];
cu1(17179869184*pi) q[13],q[57];
cu1(34359738368*pi) q[12],q[57];
cu1(68719476736*pi) q[11],q[57];
cu1(137438953472*pi) q[10],q[57];
cu1(274877906944*pi) q[9],q[57];
cu1(549755813888*pi) q[8],q[57];
cu1(1099511627776*pi) q[7],q[57];
cu1(2199023255552*pi) q[6],q[57];
cu1(4398046511104*pi) q[5],q[57];
cu1(8796093022208*pi) q[4],q[57];
cu1(17592186044416*pi) q[3],q[57];
cu1(35184372088832*pi) q[2],q[57];
cu1(70368744177664*pi) q[1],q[57];
cu1(140737488355328*pi) q[0],q[57];
h q[0];
measure q[0] -> c0[0];
if(c0==1) u1(-pi/2) q[1];
if(c0==1) u1(-pi/4) q[2];
