...
h q[23];
h q[24];
cu1(pi/512) q[24],q[25];
cu1(pi/256) q[23],q[25];
cu1(pi/128) q[22],q[25];
cu1(pi/64) q[21],q[25];
cu1(pi/32) q[20],q[25];
cu1(pi/16) q[19],q[25];
cu1(pi/8) q[18],q[25];
...
cu1(256*pi) q[7],q[25];
cu1(512*pi) q[6],q[25];
cu1(1024*pi) q[5],q[25];
cu1(2048*pi) q[4],q[25];
cu1(4096*pi) q[3],q[25];
cu1(8192*pi) q[2],q[25];
cu1(16384*pi) q[1],q[25];
cu1(32768*pi) q[0],q[25];
h q[0];
measure q[0] -> c0[0];
if(c0==1) u1(-pi/2) q[1];
if(c0==1) u1(-pi/4) q[2];
