...
h q[29];
h q[30];
cu1(pi/512) q[30],q[31];
cu1(pi/256) q[29],q[31];
cu1(pi/128) q[28],q[31];
cu1(pi/64) q[27],q[31];
cu1(pi/32) q[26],q[31];
cu1(pi/16) q[25],q[31];
cu1(pi/8) q[24],q[31];
...
cu1(32*pi) q[16],q[31];
cu1(64*pi) q[15],q[31];
cu1(128*pi) q[14],q[31];
cu1(256*pi) q[13],q[31];
cu1(512*pi) q[12],q[31];
cu1(1024*pi) q[11],q[31];
cu1(2048*pi) q[10],q[31];
cu1(4096*pi) q[9],q[31];
cu1(8192*pi) q[8],q[31];
cu1(16384*pi) q[7],q[31];
cu1(32768*pi) q[6],q[31];
cu1(65536*pi) q[5],q[31];
cu1(131072*pi) q[4],q[31];
cu1(262144*pi) q[3],q[31];
cu1(524288*pi) q[2],q[31];
cu1(1048576*pi) q[1],q[31];
cu1(2097152*pi) q[0],q[31];
h q[0];
measure q[0] -> c0[0];
if(c0==1) u1(-pi/2) q[1];
if(c0==1) u1(-pi/4) q[2];
