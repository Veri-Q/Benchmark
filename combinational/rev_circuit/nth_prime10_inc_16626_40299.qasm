...
gate mcx_gray_140155720188352 q0,q1,q2,q3,q4,q5,q6,q7,q8 { h q8; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7,q8; h q8; }
gate mcx_gray_140155725478976 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_gray_140155725447376 q0,q1,q2,q3,q4,q5,q6,q7,q8,q9 { h q9; mcu1(pi) q0,q1,q2,q3,q4,q5,q6,q7,q8,q9; h q9; }
qreg q[11];
x q[0];
cx q[3],q[2];
cx q[2],q[1];
...
x q[5];
ccx q[9],q[8],q[7];
mcx_gray_140155720188352 q[0],q[1],q[2],q[3],q[4],q[5],q[6],q[7],q[9];
ccx q[9],q[8],q[7];
...
x q[5];
mcx q[0],q[2],q[3],q[1];
mcx_gray_140155725478976 q[4],q[5],q[6],q[7],q[8],q[9],q[0];
mcx q[0],q[2],q[3],q[1];
mcx q[1],q[2],q[3],q[9];
...
cx q[2],q[10];
x q[5];
mcx_gray_140155725447376 q[2],q[3],q[4],q[5],q[6],q[7],q[8],q[9],q[10],q[0];
x q[9];
x q[8];
x q[7];
x q[5];
