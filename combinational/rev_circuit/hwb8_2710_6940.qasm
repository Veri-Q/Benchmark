...
ccx q[0],q[3],q[2];
mcx_140155732839824 q[0],q[2],q[3],q[1];
mcx q[4],q[5],q[6],q[7],q[0];
mcx q[0],q[2],q[3],q[1];
x q[4];
cx q[0],q[3];
...
ccx q[0],q[1],q[2];
x q[4];
mcx_gray_140155731829040 q[2],q[3],q[4],q[5],q[6],q[7],q[0];
x q[6];
x q[4];
ccx q[0],q[1],q[2];
cx q[2],q[7];
