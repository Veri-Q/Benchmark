...
gate mcx_140155668475856 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
...
cx q[4],q[5];
mcx q[0],q[2],q[4],q[3];
mcx_140155668475856 q[0],q[1],q[3],q[5],q[2];
ccx q[0],q[2],q[1];
ccx q[2],q[4],q[5];
