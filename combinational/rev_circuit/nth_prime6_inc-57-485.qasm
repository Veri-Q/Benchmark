...
gate mcx_140155733724464 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
...
mcx q[0],q[1],q[5],q[2];
x q[1];
mcx_140155733724464 q[0],q[1],q[3],q[4],q[5];
x q[1];
cx q[2],q[0];
ccx q[2],q[3],q[1];
mcx q[1],q[2],q[3],q[0];
