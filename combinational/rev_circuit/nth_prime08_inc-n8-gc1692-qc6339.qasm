...
gate mcx_gray_140155734773920 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
gate mcx_140155734818528 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
qreg q[8];
cx q[0],q[5];
cx q[3],q[7];
cx q[4],q[6];
...
cx q[0],q[7];
ccx q[2],q[7],q[0];
mcx_gray_140155734773920 q[0],q[1],q[3],q[4],q[5],q[6],q[2];
ccx q[2],q[7],q[0];
cx q[0],q[7];
cx q[0],q[2];
cx q[7],q[0];
...
cx q[5],q[2];
cx q[5],q[3];
mcx_140155734818528 q[0],q[1],q[2],q[6],q[5];
cx q[5],q[2];
cx q[5],q[3];
cx q[7],q[0];
cx q[7],q[4];
