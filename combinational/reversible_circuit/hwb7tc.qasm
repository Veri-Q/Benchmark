...
gate mcx_140155722021568 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_140155727120944 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
qreg q[7];
ccx q[4],q[6],q[1];
ccx q[1],q[3],q[6];
ccx q[1],q[3],q[0];
...
ccx q[0],q[4],q[3];
mcx q[0],q[1],q[4],q[2];
mcx_140155722021568 q[0],q[1],q[2],q[3],q[4];
ccx q[4],q[6],q[0];
ccx q[2],q[4],q[6];
ccx q[0],q[4],q[2];
ccx q[0],q[4],q[1];
...
mcx_gray_140155727120944 q[0],q[1],q[2],q[3],q[5],q[6],q[4];
