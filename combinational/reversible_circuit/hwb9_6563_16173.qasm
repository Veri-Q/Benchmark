...
gate mcx_140155620227392 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
...
ccx q[7],q[8],q[6];
mcx q[0],q[5],q[6],q[8];
mcx_140155620227392 q[1],q[2],q[3],q[4],q[0];
mcx q[0],q[5],q[6],q[8];
ccx q[7],q[8],q[6];
mcx q[0],q[5],q[6],q[7];
