...
gate mcx_140155733956448 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
...
cx q[2],q[5];
ccx q[1],q[5],q[2];
mcx_140155733956448 q[2],q[3],q[4],q[6],q[0];
ccx q[1],q[5],q[2];
cx q[2],q[5];
cx q[5],q[4];
cx q[4],q[2];
