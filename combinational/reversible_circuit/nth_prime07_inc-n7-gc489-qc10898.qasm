...
gate mcx_140155626735264 q0,q1,q2,q3,q4 { h q4; cu1(pi/2) q3,q4; h q4; rcccx q0,q1,q2,q3; h q4; cu1(-pi/2) q3,q4; h q4; rcccx_dg q0,q1,q2,q3; c3sx q0,q1,q2,q4; }
gate mcx_gray q0,q1,q2,q3,q4,q5 { h q5; mcu1(pi) q0,q1,q2,q3,q4,q5; h q5; }
gate mcx_gray_140155626735312 q0,q1,q2,q3,q4,q5,q6 { h q6; mcu1(pi) q0,q1,q2,q3,q4,q5,q6; h q6; }
qreg q[7];
ccx q[5],q[6],q[3];
mcx q[3],q[4],q[5],q[0];
mcx q[3],q[4],q[5],q[1];
mcx_140155626735264 q[0],q[2],q[5],q[6],q[3];
ccx q[5],q[6],q[2];
ccx q[5],q[6],q[1];
...
cx q[5],q[4];
cx q[2],q[5];
mcx_gray_140155626735312 q[0],q[1],q[3],q[4],q[5],q[6],q[2];
cx q[1],q[4];
cx q[0],q[1];
cx q[0],q[3];
